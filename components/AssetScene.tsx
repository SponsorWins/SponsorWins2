...
export default function AssetScene({ asset, team }: { asset: string; team: string }) {
  ...
  // Inline SVG scenes – match the mock look
      ...
      <svg viewBox="0 0 360 200" role="img" aria-label="Jersey Patch">
        <defs>
          <linearGradient id="bgJ" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0" stopColor="#102148"/><stop offset="1" stopColor="#07142c"/>
          </linearGradient>
        </defs>
  ...
  if (/Pitch-Level/i.test(asset)) {
    return (
      <svg viewBox="0 0 360 200" role="img" aria-label="Pitch-Level Signage">
  ...
  return (
    <svg viewBox="0 0 360 200"><rect width="100%" height="100%" fill="#0c1736"/></svg>
  );
}
